package com.angel.willy.Utils.GlideUtils;
...
public class GlideBlurTransformation extends BitmapTransformation {
    ...
    /**
     * @param originBitmap
     * @param scaleRatio 裁剪系数
     * @return
     */
    public Bitmap toBlur(Bitmap originBitmap,int scaleRatio){
        if(scaleRatio<=10){
            scaleRatio=10;
        }
        ...
        return doBlur(scaledBitmap,8,true);
    }
